...
function makeWorld(): WorldState {
  return {
    meta: { schemaVersion: 10, seed: "s", rng: [1, 2, 3, 4], turn: 5, date: "1953-02-10", era: "1953", cheatsUsed: false },
    countries: {
    ...
    player: { name: "P", countryId: "US", cash: 10000, actions: 25, funds: 0, donorBaseLevel: 0, politicalInfluence: 0, favorability: 50, infamy: 0, actionCooldowns: {} },
    parties: {},
    legislatures: {},
    politicians: [],
    charters: [],
