...
1. **Launcher screen** as the app entry: three clear entries (Play Online, New World, Load Save), using the real red-and-navy Liberty Bell logo, warm paper-ballot identity, traditional serif display type, and a quiet printed world map. Preserve direct hierarchy, large touch targets, and a compact mobile flow. Avoid invented insignia, terminal styling, and ornamental motion.
