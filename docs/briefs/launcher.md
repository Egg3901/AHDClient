...
1. **Launcher screen** as the app entry: three clear entries (Play Online, New World, Load Save), with a restrained dark editorial design, direct hierarchy, large touch targets, and a compact mobile flow. Keep it fast and task-led, not ornamental.
